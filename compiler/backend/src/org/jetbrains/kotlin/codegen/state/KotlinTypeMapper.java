...
public class KotlinTypeMapper {
    ...
    private void writeGenericType(
        ...
        int indexOfParameterizedType = indexOfFirstParameterizedType(innerTypesAsList);
    ...
    private static int indexOfFirstParameterizedType(@NotNull List<PossiblyInnerType> innerTypesAsList) {
        return CollectionsKt.indexOfFirst(innerTypesAsList, innerPart -> !innerPart.getArguments().isEmpty());
    }
