...
abstract class AbstractLocalInspectionTest  : KotlinLightCodeInsightFixtureTestCase() {
    ...
    protected open fun areProblemsExpectedDirectiveName(): String = "PROBLEMS"
    ...
    private fun doTestFor(mainFilePath: String, psiFile: PsiFile, inspection: AbstractKotlinInspection, fileText: String) {
        val areProblemsExpectedString = InTextDirectivesUtils.findStringWithPrefixes(
                fileText, "// ${areProblemsExpectedDirectiveName()}: ")
        val problemsExpected = areProblemsExpectedString == null || areProblemsExpectedString == "true"
        ...
        Assert.assertTrue(
                ...
                problemsExpected == problemDescriptors.isNotEmpty())
        if (!problemsExpected) return
